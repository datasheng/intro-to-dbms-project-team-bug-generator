...
const CourseDetails = ({ course, onBack, onSave, onDelete }) => {
  ...
  const handleDelete = () => {
    ...
    onDelete(course.id); // Add delete course
  };
...
const InstructorCenter = () => {
  ...
  const handleDeleteCourse = (courseId) => {
    ...
    setCourses(courses.filter((course) => course.id !== courseId)); // Add delete function
    setSelectedCourse(null); // Add after delete make null
  };
    ...
    <div className="container mx-auto p-4 max-w-7xl">
      ...
      {selectedCourse ? (
        <CourseDetails
          ...
          onDelete={handleDeleteCourse} // Add delete function
        />
      ) : (
